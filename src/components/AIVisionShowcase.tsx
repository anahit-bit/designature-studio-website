    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-center">
          <span className="font-display text-2xl font-light text-black/20">&#8594;</span>
        </div>
      ...
      <div className="flex flex-col gap-3 md:hidden">
        ...
        <div className="flex justify-center">
          <span className="font-display text-xl font-light text-black/20">&#8595;</span>
        </div>
        <div className="flex flex-col gap-1">
          <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-black/35">Concept</span>
          <div className="overflow-hidden w-full" style={{ aspectRatio: '4/3' }}>
  ...
  return (
    <div className="w-full bg-white border-t border-black/10">
      <div className="flex flex-col items-center px-8 md:px-12 py-10 gap-7 w-full max-w-[900px] mx-auto">
        ...
        >
          <p className="text-[9px] font-bold uppercase tracking-[0.35em] text-black/25 mb-3">
            How it works
          </p>
        ...
        >
          <p className="text-[8px] font-bold uppercase tracking-[0.3em] text-black/25">Ready to see the result?</p>
          <button
