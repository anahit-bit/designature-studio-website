...
**Output:** `qa-runs/qa-runs/reports/YYYY-MM-DD-smoke.md` (+ rendered `.html`).
...
**Output:** `qa-runs/qa-runs/reports/YYYY-MM-DD-locale-smoke.md` (+ `.html`).
...
**Output:** `qa-runs/qa-runs/reports/YYYY-MM-DD.md` (+ `.html`).
...
**Output:** `qa-runs/qa-runs/reports/YYYY-MM-DD-mobile.md` (+ `.html`).
...
**Output:** `qa-runs/qa-runs/reports/YYYY-MM-DD-full-matrix.md` (or `qa-runs/qa-runs/reports/YYYY-MM-DD-full-matrix-part-N.md` for split runs) (+ `.html`).
...
**Output:** `qa-runs/qa-runs/reports/YYYY-MM-DD-retest-{ids}.md` (+ `.html`).
