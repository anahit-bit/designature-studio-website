...
Output: qa-runs/reports/YYYY-MM-DD.md (and rendered .html)
...
4. Read .claude/designature-qa/PROFILES.md and confirm the canonical profile spec matches what's above. Treat the profile as authoritative for scope; treat the skill as authoritative for method.
...
Produce the report at qa-runs/reports/YYYY-MM-DD.md following the skill's report structure:
...
Then render HTML: `node .claude/designature-qa/render-report.cjs qa-runs/reports/YYYY-MM-DD.md`.
