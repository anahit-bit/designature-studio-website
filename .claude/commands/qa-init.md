---
description: Configure (or re-configure) the QA agent for designature.studio. Walks through site URL, locales, routes, viewports, and writes qa-config.yml.
---
...
Ask: "Production site URL? (default: https://designature.studio)"
...
- **A) default-unprefixed** — en routes are `/uxcore`, ru routes are `/ru/uxcore` 
