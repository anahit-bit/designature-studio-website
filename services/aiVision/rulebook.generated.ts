 ...
 * being a rule.
 *
 * This build: 19 gemini rules · 0 staging · 8 not sent to any model
...
export const GEMINI_RULES: CompiledRule[] = [
  ...
  { id: "RD24", level: "ABSOLUTE", text: `The room programme that follows lists what the finished room CONTAINS - furniture, fittings, lighting and styling. It can never authorise building work. If any part of it would need an opening, doorway, arch, staircase, window, wall, recess or change of level that this photograph does not already show, DROP that part and furnish what is actually there. A room that reads as a dead end, or as small, or as awkwardly shaped, is the correct answer when that is the room in the photograph.` },
];
...
export const ROOM_PROGRAM_RULES: Record<string, string> = {
  ...
  bathroom: `The room MUST be a fully realized BATHROOM. It MUST be properly TILED: real wall tile behind the vanity and through the shower or bath area, and tiled or stone flooring, with visible grout lines and a tile format, colour and laying pattern chosen to suit the target style. Tile is a finish laid flat onto the walls that are already there - it never changes their plane. Include a vanity with sink(s) and mirror, a toilet, towel bars or rings with real towels, sconces or vanity lighting, a bath mat, and appropriate styling. For bathing, KEEP WHAT THE PHOTOGRAPH HAS: a bath stays a bath, a shower stays a shower, in the same place at the same size. If the photograph shows neither, fit only what the visible floor area holds without moving a wall - and if it holds neither, a vanity, toilet and mirror are a complete answer. Add a glazed shower screen only where there is a shower. Do NOT carve a new recess, niche, wet-room enclosure or partition to house a fixture, and do NOT enlarge the room to fit one. Do NOT leave the walls as bare plaster or paint alone, and do NOT include living-room furniture, bedroom furniture, or dining tables. Every fixture must be a real bathroom fixture.`,
